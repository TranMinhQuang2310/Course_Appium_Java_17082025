...
import com.quangtester.Listeners.Bai26_TestListener_UsingLogUtils;
...
public class Bai27_BaseTest_Using_Log4j2_AllureReports {
...
//            CaptureHelpers.stopRecording(videoFileName);
    ...
    public void downloadDataFromServer(int dataNumber) {
        ...
        Bai27_MobileUI_Using_LogUtils_AllureReport.sleep(5);
        ...
        Bai27_MobileUI_Using_LogUtils_AllureReport.sleep(1);
        ...
        Bai27_MobileUI_Using_LogUtils_AllureReport.sleep(2);
