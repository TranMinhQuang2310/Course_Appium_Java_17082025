...
public class MenuPage extends BasePage {
    ...
    public void searchTable(String tableName) {
        ...
        Bai27_MobileUI_Using_LogUtils_AllureReport.clickElement_UseWebElement_NoSetTimeout(inputSearch);
        //Nhập dữ liệu vào thanh search
        Bai27_MobileUI_Using_LogUtils_AllureReport.setText_UseWebElement_NoSetTimeout(inputSearch,tableName);
    }
    ...
    public void checkTableResultTotal(int expectedTotal) {
        ...
        Bai27_MobileUI_Using_LogUtils_AllureReport.assertTrueCondition(listTables.size() >= expectedTotal,"Total item is not correct");
    }
}
