...
public class MenuPage extends BasePage {
    ...
    public void searchTable(String tableName) {
        ...
        Bai26_MobileUI_UsingLogUtils.clickElement_UseWebElement_NoSetTimeout(inputSearch);
        //Nhập dữ liệu vào thanh search
        Bai26_MobileUI_UsingLogUtils.setText_UseWebElement_NoSetTimeout(inputSearch,tableName);
    }
    ...
    public void checkTableResultTotal(int expectedTotal) {
        ...
        Bai26_MobileUI_UsingLogUtils.assertTrueCondition(listTables.size() >= expectedTotal,"Total item is not correct");
    }
}
