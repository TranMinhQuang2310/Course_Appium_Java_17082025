...
import com.quangtester.keywords.Bai27_MobileUI_Using_LogUtils_AllureReport;
...
public class LoginPage extends BasePage {
    ...
    public MenuPage login(String username , String password) {
        Bai27_MobileUI_Using_LogUtils_AllureReport.clickElement_UseWebElement_NoSetTimeout(usernameField); // Click vào username field
        Bai27_MobileUI_Using_LogUtils_AllureReport.setText_UseWebElement_NoSetTimeout(usernameField,username); // Nhập username
        Bai27_MobileUI_Using_LogUtils_AllureReport.clickElement_UseWebElement_NoSetTimeout(passwordField); // Click vào password field
        Bai27_MobileUI_Using_LogUtils_AllureReport.setText_UseWebElement_NoSetTimeout(passwordField,password); // Nhập password
        Bai27_MobileUI_Using_LogUtils_AllureReport.clickElement_UseWebElement_NoSetTimeout(loginButton); // Click nút login
    ...
    public MenuPage verifyLoginSuccess() {
        ...
        Bai27_MobileUI_Using_LogUtils_AllureReport.verifyElementPresentAndDisplayed_UseWebElement(menuMenu,"The Table page not display. (Menu not found)");
    ...
    public void verifyLoginFail() {
        Bai27_MobileUI_Using_LogUtils_AllureReport.verifyElementPresentAndDisplayed_UseWebElement(errorMessage,"The error message not display.");
        System.out.println(Bai27_MobileUI_Using_LogUtils_AllureReport.getElementAttribute_UseWebElement_NoSetTimeout(errorMessage,"content-desc"));
        Bai27_MobileUI_Using_LogUtils_AllureReport.verifyElementAttribute_UseWebElement(errorMessage,"content-desc"," Invalid email or password", "The content of error message not display.");
    }
}
