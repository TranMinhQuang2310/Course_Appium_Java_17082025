package com.quangtester.Bai25_Screenshot_RecordVideo.pages;

import com.quangtester.Bai25_Screenshot_RecordVideo.pages.MenuPage;
...
public class LoginPage extends BasePage {
    ...
    public MenuPage login(String username , String password) {
        MobileUI.clickElement_UseWebElement_NoSetTimeout(usernameField); // Click vào username field
        MobileUI.setText_UseWebElement_NoSetTimeout(usernameField,username); // Nhập username
        MobileUI.clickElement_UseWebElement_NoSetTimeout(passwordField); // Click vào password field
        MobileUI.setText_UseWebElement_NoSetTimeout(passwordField,password); // Nhập password
        MobileUI.clickElement_UseWebElement_NoSetTimeout(loginButton); // Click nút login
    ...
    public MenuPage verifyLoginSuccess() {
        ...
        MobileUI.verifyElementPresentAndDisplayed_UseWebElement(menuMenu,"The Table page not display. (Menu not found)");
    ...
    public void verifyLoginFail() {
        MobileUI.verifyElementPresentAndDisplayed_UseWebElement(errorMessage,"The error message not display.");
        System.out.println(MobileUI.getElementAttribute_UseWebElement_NoSetTimeout(errorMessage,"content-desc"));
        MobileUI.verifyElementAttribute_UseWebElement(errorMessage,"content-desc"," Invalid email or password", "The content of error message not display.");
    }
}
