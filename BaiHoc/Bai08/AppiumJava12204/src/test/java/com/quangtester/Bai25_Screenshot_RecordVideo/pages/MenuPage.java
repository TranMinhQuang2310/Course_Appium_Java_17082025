...
public class MenuPage extends BasePage {
    ...
    public void searchTable(String tableName) {
        ...
        MobileUI.clickElement_UseWebElement_NoSetTimeout(inputSearch);
        //Nhập dữ liệu vào thanh search
        MobileUI.setText_UseWebElement_NoSetTimeout(inputSearch,tableName);
    }
    ...
    public void checkTableResultTotal(int expectedTotal) {
        ...
        MobileUI.assertTrueCondition(listTables.size() >= expectedTotal,"Total item is not correct");
    }
}
